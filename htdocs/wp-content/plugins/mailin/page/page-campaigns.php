...
if(!class_exists('SIB_Page_Campaigns'))
{
    class SIB_Page_Campaigns
    {
        ...
        function generate_main_page()
        {
            ...
            $sort = isset($_GET['sort']) ? $_GET['sort'] : 'sent_c';
            ...
            ?>
                ...
                if($sort == 'create') {
                    $type = isset($_GET['type']) ? $_GET['type'] : 'classic';
                    ?>
                    <iframe id="datamain"
                            src="https://my.sendinblue.com/camp/step1/type/<?php echo $type;?>/access_token/<?php echo $access_token; ?>/lang/<?php echo $lang; ?>"
                    ...
                    ?>
                    <iframe id="datamain"
                        src="https://my.sendinblue.com/camp/listing/access_token/<?php echo $access_token; ?>/lang/<?php echo $lang; ?>#<?php echo $sort; ?>"
                        width="100%" height="750" scrolling="yes"></iframe>
